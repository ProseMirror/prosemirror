...
test("parent_block", pm => {
  ...
  pm.execCommand("selectParentNode")
  cmpStr(pm.selection.from, 2, "to list item")
  pm.execCommand("selectParentNode")
  cmpStr(pm.selection.from, 1, "to list")
  pm.execCommand("selectParentNode")
  cmpStr(pm.selection.from, 1, "stop at toplevel")
...
test("onto_block", pm => {
  ...
  cmpStr(pm.selection.from, 2, "moved up onto hr")
...
test("delete_block", pm => {
  ...
  cmpStr(pm.selection.head, 5, "back to paragraph above")
  pm.setNodeSelection(0)
  pm.execCommand("deleteSelection")
...
test("replace_selection_block", pm => {
  ...
  cmpStr(pm.selection.from, 7, "moved to hr")
